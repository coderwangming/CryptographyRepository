...
public class BloomFilter<E> implements Serializable {
	...
	/**
	 * Returns true if any element of a Collection could have been inserted into
	 * the Bloom filter. Use getFalsePositiveProbability() to calculate the
	 * probability of this being correct.
	 * 
	 * @param c
	 *            elements to check.
	 * @return true if any element of a Collection could have been inserted into
	 *         the Bloom filter
	 */
	public boolean contains(Collection<? extends E> c) {
		for (E element : c)
			if (contains(element))
				return true;
		return false;
