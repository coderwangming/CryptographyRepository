...
import itertools, re
from lib import vigenereCipher, pyperclip, freqAnalysis, detectEnglish
...
#得到重复的序列之间的距离
#其中Spacing在这里的定义就是两个序列之间的距离
#输入：密文
#输出：{'VRA': [8, 2, 4, 2, 3, 4, 6, 8, 12, 16, 8, 2, 4],'AZU': [2, 3, 4, 6, 8, 12, 16, 24], 'YBN': [8, 2, 4]}.
...
#得到每个因子出现的次数
#输入：{'VRA': [8, 2, 4, 2, 3, 4, 6, 8, 12, 16, 8, 2, 4],'AZU': [2, 3, 4, 6, 8, 12, 16, 24], 'YBN': [8, 2, 4]}.
#输出：s [(3, 556),(2, 541), (6, 529), (4, 331), (12, 325), (8, 171), (9, 156), (16,105), (5, 98), (11, 86), (10, 84), (15, 84), (7, 83), (14, 68),(13, 52)].代表因子3出现了556次 2出现了541次等等
def getMostCommonFactors(seqFactors):
    #1.首先得到{3：556，2：541，9：156}这样的dict
    ...
    #2.将factor和它出现的次数放在一个tuple中，并且做成一个list
...
#kasiskiExamination算法的过程
#输入：密文
#输出：该密文可能采用的密钥的长度
def kasiskiExamination(ciphertext):
    #1.找出重复序列之间的spaceings
...
#获得密文中第n个 每过keyLength个字母 组成的密文
#n要获得第几个subkey
#keylength 代表subkey的长度
#message 密文
